...
const poolScript = [
  ...
  [makeEvilPool, [
    ...
    () => { updateMiasma(5); Scene(createBattleScene(8, 0, 0, `deceit`)) },
  ]],
  ...
  [makeEvilPool, [
    ...
    () => { updateMiasma(4); Scene(createBattleScene(6, 6, 0, `resentment`)) },
  ]],
  ...
  [makeEvilPool, [
    ...
    () => { updateMiasma(2); Scene(createBattleScene(0, 8, 2, `doubt`)) },
  ]],
  ...
  [makeEvilPool, [
    [`It hurt he told you is wasn't meant to, but it did.`, originalAuthor],
